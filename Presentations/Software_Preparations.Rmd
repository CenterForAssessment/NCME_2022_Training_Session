...
- If you don't already have R installed, please go ahead an install it from [CRAN](https://cran.r-project.org/) picking the version that goes with your operating systems.
