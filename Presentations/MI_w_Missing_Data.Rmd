...
subtitle: "Multiple Imputation with Simulated Missing Data"
author: "Adam VanIwaarden, Damian Betebenner & Nathan Dadey"
...
``` {r mi_wf_vB, out.width='75%', fig.align='center', echo=FALSE, eval = TRUE}
knitr::include_graphics("Figures/ch01-miflow-1.png", error = FALSE)
```
---
...
gridExtra::grid.arrange(truth.p, truth.c, 
												impute.p, impute.c, 
												ampute.p, ampute.c, ncol=2)
```
